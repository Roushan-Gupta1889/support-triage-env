"""
Learning curve from trajectory logs. Run from repo root, e.g.:
...
def plot_learning_curve(data, output_file="learning_curve.svg"):
    ...
    colors = {
        "ticket_category": "#2ea043",
        "ticket_priority": "#e3b341",
        "full_resolution": "#d29922",
        "escalation_detection": "#f85149",
    }
    ...
    ax.set_title(
        "Agent Learning Story: Reward Trajectory per Episode",
        fontsize=16,
        fontweight="bold",
        pad=20,
        color="white",
    ...
    ax.set_xlabel(
        "Episode Step (Reasoning + Environment Feedback Iteration)",
        fontsize=12,
        color="#cccccc",
    )
